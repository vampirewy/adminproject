  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: ["导购管理", "导购设置"],
          component: () =>
            import(/* webpackChunkName: "addShopping" */ "./views/shoppingGuide/addshopping.vue")
        ...
        },
        {
          ...
          meta: ["专题管理", "专题列表"],
          component: () =>
            import(/* webpackChunkName: "specialGuide" */ "./views/specialGuide/specialguide.vue")
        ...
        // },
        {
          ...
          meta: ["专题管理", "信息"],
          component: () =>
            import(/* webpackChunkName: "specialInfor" */ "./views/specialGuide/aboutSpecial/specialinfor.vue")
        ...
        },
        {
          ...
          meta: ["专题管理", "商品"],
          component: () =>
            import(/* webpackChunkName: "specialGood" */ "./views/specialGuide/aboutSpecial/specialgood.vue")
        ...
        },
        {
          ...
          meta: ["弹窗管理", "列表"],
          component: () =>
            import(/* webpackChunkName: "popmanager" */ "./views/popmanager/popmanager.vue")
        },
        {
          path: "addpop",
          name: "addpop",
          meta: ["弹窗管理", "添加"],
          component: () =>
            import(/* webpackChunkName: "addpop" */ "./views/popmanager/add/addpop.vue")
        }
      ]
    }
  ]
